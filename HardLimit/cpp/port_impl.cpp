...
/*******************************************************************************************
    ...
    AUTO-GENERATED CODE. DO NOT MODIFY
 	...
 	Generated on: Thu Feb 21 13:40:21 EST 2013
 	Redhawk IDE
 	Version:M.1.8.2
...
// ----------------------------------------------------------------------------------------
BULKIO_dataDouble_Out_i::BULKIO_dataDouble_Out_i(std::string port_name, HardLimit_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<HardLimit_i *> (_parent);
...
// ----------------------------------------------------------------------------------------
BULKIO_dataDouble_In_i::BULKIO_dataDouble_In_i(std::string port_name, HardLimit_base *_parent) : 
