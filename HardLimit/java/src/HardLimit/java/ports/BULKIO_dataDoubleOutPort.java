 ...
 * @generated
 */
public class BULKIO_dataDoubleOutPort extends QueryableUsesPort<dataDoubleOperations> implements UsesPortStatisticsProviderOperations {
    ...
    protected dataDoubleOperations narrow(org.omg.CORBA.Object connection)  
    {
        dataDoubleOperations ops = dataDoubleHelper.narrow(connection);
    ...
    public void connectPort(final org.omg.CORBA.Object connection, final String connectionId) throws CF.PortPackage.InvalidPort, CF.PortPackage.OccupiedPort
    {
        synchronized (this.updatingPortsLock) {
            ...
            final dataDoubleOperations port = dataDoubleHelper.narrow(connection);
