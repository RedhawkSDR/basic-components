...
# Generated on: Thu Feb 21 13:40:19 EST 2013
# Redhawk IDE
# Version:M.1.8.2
...
class HardLimit_base(CF__POA.Resource, Resource):
        ...
        def initialize(self):
            ...
            self.port_dataDouble_in = PortBULKIODataDoubleIn_i(self, "dataDouble_in", self.DEFAULT_QUEUE_SIZE)

            self.port_dataDouble_out = PortBULKIODataDoubleOut_i(self, "dataDouble_out")
        ...
        class PortBULKIODataDoubleIn(BULKIO__POA.dataDouble):
            """This class is a port template for the dataDouble_in port and
            should not be instantiated nor modified.
            
            The expectation is that the specific port implementation will extend 
            from this class instead of the base CORBA class BULKIO__POA.dataDouble.
            """
            pass
        ...
        class PortBULKIODataDoubleOut(BULKIO__POA.UsesPortStatisticsProvider):
            """This class is a port template for the dataDouble_out port and
            should not be instantiated nor modified.
...
class PortBULKIODataDoubleIn_i(HardLimit_base.PortBULKIODataDoubleIn):
...
class PortBULKIODataDoubleOut_i(HardLimit_base.PortBULKIODataDoubleOut):
    class linkStatistics:
        class statPoint:
            def __init__(self):
                self.elements = 0
