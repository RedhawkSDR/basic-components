...
class medianfilter_base(CF__POA.Resource, Resource):
        ...
        def initialize(self):
            ...
            self.port_dataFloat_in = PortBULKIODataFloatIn_i(self, "dataFloat_in", self.DEFAULT_QUEUE_SIZE)

            self.port_dataFloat_out = PortBULKIODataFloatOut_i(self, "dataFloat_out")
        ...
        class PortBULKIODataFloatIn(BULKIO__POA.dataFloat):
            """This class is a port template for the dataFloat_in port and
        ...
        class PortBULKIODataFloatOut(BULKIO__POA.UsesPortStatisticsProvider):
            """This class is a port template for the dataFloat_out port and
            should not be instantiated nor modified.
...
class PortBULKIODataFloatIn_i(medianfilter_base.PortBULKIODataFloatIn):
...
class PortBULKIODataFloatOut_i(medianfilter_base.PortBULKIODataFloatOut):
    class linkStatistics:
        class statPoint:
            def __init__(self):
                self.elements = 0
