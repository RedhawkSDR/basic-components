...
# Generated on: Thu Feb 28 19:12:33 EST 2013
# Redhawk IDE
# Version:M.1.8.3
...
class SCAAudioTagger_base(CF__POA.Resource, Resource):
        ...
        class PortBULKIODataShortIn(BULKIO__POA.dataShort):
            """This class is a port template for the dataShort_in port and
            should not be instantiated nor modified.
            
            The expectation is that the specific port implementation will extend 
            from this class instead of the base CORBA class BULKIO__POA.dataShort.
            """
            pass
        ...
        class PortBULKIODataShortOut(BULKIO__POA.UsesPortStatisticsProvider):
            """This class is a port template for the dataShort_out port and
            should not be instantiated nor modified.
        ...
        # or by using the IDE.       
        encoding = simple_property(id_="encoding",
                                          type_="string",
                                          defvalue="PCM_SIGNED",
                                          mode="readwrite",
                                          action="external",
        ...
        channels = simple_property(id_="channels",
                                          type_="long",
                                          defvalue=1,
                                          mode="readwrite",
                                          action="external",
                                          kinds=("configure",),
                                          description="""Number of channels in audio stream""" 
                                          )

'''provides port(s)'''


class PortBULKIODataShortIn_i(SCAAudioTagger_base.PortBULKIODataShortIn):
...
class PortBULKIODataShortOut_i(SCAAudioTagger_base.PortBULKIODataShortOut):
    class linkStatistics:
        class statPoint:
            def __init__(self):
                self.elements = 0
