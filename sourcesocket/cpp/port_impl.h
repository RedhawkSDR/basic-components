...
{
    public:
        BULKIO_dataUshort_Out_i(std::string port_name, sourcesocket_base *_parent);
...
{
    public:
        BULKIO_dataShort_Out_i(std::string port_name, sourcesocket_base *_parent);
...
{
    public:
        BULKIO_dataUlong_Out_i(std::string port_name, sourcesocket_base *_parent);
...
{
    public:
        BULKIO_dataChar_Out_i(std::string port_name, sourcesocket_base *_parent);
...
{
    public:
        BULKIO_dataDouble_Out_i(std::string port_name, sourcesocket_base *_parent);
...
{
    public:
        BULKIO_dataFloat_Out_i(std::string port_name, sourcesocket_base *_parent);
...
{
    public:
        BULKIO_dataLong_Out_i(std::string port_name, sourcesocket_base *_parent);
...
{
    public:
        BULKIO_dataOctet_Out_i(std::string port_name, sourcesocket_base *_parent);
