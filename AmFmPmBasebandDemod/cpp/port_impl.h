...
{
    public:
        BULKIO_dataFloat_Out_i(std::string port_name, AmFmPmBasebandDemod_base *_parent);
...
{
    public:
        BULKIO_dataFloat_In_i(std::string port_name, AmFmPmBasebandDemod_base *_parent);
