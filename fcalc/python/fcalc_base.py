...
# Generated on: Fri Mar 08 13:37:04 EST 2013
# Redhawk IDE
# Version:M.1.8.2
...
class fcalc_base(CF__POA.Resource, Resource):
        ...
        class PortBULKIODataDoubleIn(BULKIO__POA.dataDouble):
            """This class is a port template for the a port and
...
class PortBULKIODataDoubleIn_i(fcalc_base.PortBULKIODataDoubleIn):
...
class PortBULKIODataDoubleOut_i(fcalc_base.PortBULKIODataDoubleOut):
    class linkStatistics:
        class statPoint:
            def __init__(self):
                self.elements = 0
