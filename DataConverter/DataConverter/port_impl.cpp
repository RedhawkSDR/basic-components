...
/*******************************************************************************************
    ...
    AUTO-GENERATED CODE. DO NOT MODIFY
 	...
 	Generated on: Thu Mar 07 11:24:02 EST 2013
 	Redhawk IDE
 	Version:M.1.8.2
...
// ----------------------------------------------------------------------------------------
BULKIO_dataChar_Out_i::BULKIO_dataChar_Out_i(std::string port_name, DataConverter_base *_parent) :
Port_Uses_base_impl(port_name)
{
    parent = static_cast<DataConverter_i *> (_parent);
    recConnectionsRefresh = false;
...
// ----------------------------------------------------------------------------------------
BULKIO_dataChar_In_i::BULKIO_dataChar_In_i(std::string port_name, DataConverter_base *_parent) : 
Port_Provides_base_impl(port_name)
{
    dataAvailable = new omni_condition(&dataAvailableMutex);
    queueSem = new queueSemaphore(100);
